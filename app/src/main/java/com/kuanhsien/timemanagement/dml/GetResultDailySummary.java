...
public class GetResultDailySummary {
    ...
    public GetResultDailySummary() {
    }

    public GetResultDailySummary(String mode, String verNo, String categoryName, String categoryColor, int categoryPriority, String taskName, String taskColor, String taskIcon, int taskPriority, int costTime, int planTime) {
        mMode = mode;
        mVerNo = verNo;
        mCategoryName = categoryName;
        mCategoryColor = categoryColor;

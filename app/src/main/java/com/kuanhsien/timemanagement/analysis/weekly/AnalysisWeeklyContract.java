...
package com.kuanhsien.timemanagement.analysis.weekly;
...
import com.kuanhsien.timemanagement.analysis.weekly.AnalysisWeeklyContract;
 ...
 */
public interface AnalysisWeeklyContract {
...
//        void result(int requestCode, int resultCode);
        ...
        void getResultWeeklySummary();

        // 1-2. [Send-to-View] request fragment to show data
        void showResultWeeklySummary(List<GetResultDailySummary> bean);

 ...
 */
public class AnalysisDailyAdapter extends RecyclerView.Adapter {
    private static final String MSG = "AnalysisDailyAdapter: ";
    ...
    public AnalysisDailyAdapter(List<GetResultDailySummary> bean, AnalysisDailyContract.Presenter presenter) {
